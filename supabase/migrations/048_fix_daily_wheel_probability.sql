-- ============================================================
-- PREMIAJÁ — Migration 048: Corrigir Sistema de Probabilidade da Roleta
-- ============================================================
-- Esta migração garante que o backend respeite estritamente os pesos de
-- probabilidade (percentages) de cada prêmio ao invés de usar sorteio uniforme.
